...
import { ButtonRenderIt }
    from '@/shared/ui/buttons/Button/_tests_/it/Button.render.it.tsx';
import ButtonRenderWithStylesIt
    from '@/shared/ui/buttons/Button/_tests_/it/Button.render-with-css.it.tsx';
import ButtonRenderWithStyletypesIt
    from '@/shared/ui/buttons/Button/_tests_/it/Button.render-with-styletypes.it.tsx';
import ButtonOnclickWordsAndDataIt
    from '@/shared/ui/buttons/Button/_tests_/it/Button.onclick-words-and-data.it.tsx';
import { ButtonRenderWithAriaIt }
    from '@/shared/ui/buttons/Button/_tests_/it/Button.render-with-aria.it.tsx';
